...
public class TwoSumWithCalipers implements TwoSum {
	 ...
	 * @param function a function which takes a triple and returns the comparison of
	 *                 sum of the triple with zero.
	...
	public static List<Pair> calipers(int[] a, Function<Pair, Integer> function) {
		...
		while (low < high) {
			Pair p = new Pair(a[low], a[high]);
			int currentSum = function.apply(p);
